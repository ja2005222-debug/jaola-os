...
test('بوابة الفعل: الأوامر الحقيقية بكل الصيغ تمر', () => {
    const actions = [
        ...
        // أفعال المنح/الصلاحيات — "اعطي الادمن صلاحية..." حُجبت ثم دهست "نعم"
        // المشروعَ باستئناف عام (عطل إنتاجي حقيقي — سجل test-edit)
        'اعطي الادمن صلاحية اضافة أو حذف مطاعم أو رجال توصيل',
        'أعطِ المدير إمكانية تعديل الأسعار',
        'امنح المستخدم خيار حذف حسابه',
        'خصص لوحة تحكم للمشرف',
    ];
