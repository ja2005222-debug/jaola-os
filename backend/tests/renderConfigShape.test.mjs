...
test('مواضعُ الجواب الخمسة كما قِيست — أيُّ تغييرٍ قرارٌ لا انزلاق', () => {
    ...
    assert.deepEqual(sites.sort(), [
        'agents/renderAgent.js:174 → hasBackend',
        ...
        // «جسرُ GitHub»: مسارُ `/api/project/import-repo` أُدرج فوقَه (قبل `/api/chat`)
        ...
        'server.js:2518 → false',
        'services/deployAutomation.js:253 → true',
