...
test('الكلون بوثيقة: الإكمالُ يطلب البنودَ بنصّها، ورقعةٌ تُعطي أثراً لثلاثةٍ → «أُكمل من وثيقتك (3/26)» والحكمُ يعدّ ما بقي بلغة الوثيقة', async () => {
    ...
    try {
        ...
        assert.equal(gate(r.verdict, 'requirements-verify').detail, '23 بنداً من 36 في وثيقتك بلا أثر: 1 الصلاحيات والأدوار (RBAC)، 9 المشتريات، 10 الموردون، 11 العملاء، 12 الخصومات، 13 الضريبة +17 (13/36 له أثر — أثرٌ لا تنفيذ؛ مفاهيمُ الفهم 8/10؛ 8 من أسطر خطّة التسليم لا تُحسَب (لا تُبنى))');   // PM/25: مفاهيمُ الفهم ٧ ← ٨
