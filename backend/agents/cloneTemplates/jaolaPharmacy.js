...
function renderSettings() { byId('stName').value = settings.name; byId('stExpiryDays').value = settings.expiryDays; byId('stCurrency').value = settings.currency; byId('stPass').value = ''; byId('stPassCur').value = ''; }
