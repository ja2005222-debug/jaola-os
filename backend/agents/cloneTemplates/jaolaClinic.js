...
function renderSettings() { byId('stName').value = settings.name; byId('stDoctor').value = settings.doctor; byId('stCurrency').value = settings.currency; byId('stPass').value = ''; byId('stPassCur').value = ''; }
