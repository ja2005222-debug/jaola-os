...
const LOG_DICT = [
    ...
    ['عقد الوكلاء ناقص — أعضاء إلزامية غائبة: ', 'Agent contract incomplete — required members missing: '],
    ...
    ['درس مسجَّل: ', 'Lesson recorded: '],
    ['(تكرار ', '(occurrence '],
    [' — أصبح توجيهاً دائماً للمولّد', ' — now a standing directive for the generator'],
    [' — نمطٌ متكرر يظهر للمشرف', ' — a recurring pattern visible to the admin'],
    ['بُني هذا المشروع بـ', 'This project was built with '],
    [' درساً متراكماً من مشاريع سابقة', ' accumulated lessons from earlier projects'],
    ['تم الحفظ', 'Saved'],
