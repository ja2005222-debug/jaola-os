...
// ═══════════════════════════════════════════════════════
const ACTION_SIGNALS = /(?:^|\s)(?:غيّ?ر|عدّ?ل|بدّ?ل|اضف|أضف|ضف|زوّ?د|زد|احذف|امسح|شيل|صحّ?ح|اصلح|أصلح|حوّ?ل|اجعل|إجعل|ضع|حط|كبّ?ر|صغّ?ر|لوّ?ن|انقل|رتّ?ب|حسّ?ن|طوّ?ر|اربط|فعّ?ل|عطّ?ل|خلّ?ي|خليه|سوّ?ي|اعمل|أعمل|اكتب|ترجم|وسّ?ع|قلّ?ل|ارفع|انزل|ثبّ?ت|اعرض|أخفِ|اخفي|استبدل|نسّ?ق|انسق|اضبط|ظبط|زبط|حرّ?ك|انقص|وسّ?ط|عرّ?ب|بسّ?ط|رمّ?م|جمّ?ل|حدّ?ث|أعد|اعد|أريد|اريد|أبغى|ابغى|أبي|ابي|عايز|عاوز|محتاج|نحتاج|نبي|ممكن تضيف|ممكن تغير|ممكن تعدل|make|add|change|remove|delete|set|update|fix|translate|resize|move|link|connect|enable|disable|replace|insert|rename|adjust|increase|decrease|show|hide|align|center|format|optimize|improve|polish|style|redesign|i want|i need|please add|please change|can you add|can you change)(?=\s|$|[؟?!.،,])/iu;
