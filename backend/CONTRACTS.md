...
### وسقوطٌ في CI ليس من هذا العمل — يُسجَّل لا يُبتلع

دُمج هذا الـSprint على **ثمانيةٍ من تسعة**، والساقطُ `Vercel` بنصٍّ صريح:
...
3. أربعَ عشرةَ من خمسَ عشرةَ خضراء: الوظائفُ الخمس كلُّها، والمحلّلاتُ
   الثمانية كلُّها.

ولا إعادةَ تشغيلٍ تُجدي: تصطدم بالحصّة نفسها أربعاً وعشرين ساعة، فليست
«تذبذباً». **ولا إصلاحَ برمجيّاً ممكناً** — لا تغييرَ في الكود يُعيد حصّةَ
حساب. عُرض الأمرُ على المالك فاختار الدمجَ على 8/9 مع تسجيل السبب.

📌 **القاعدة المستفادة**: بارُ «التسعة خضراء» يبقى، ويُستثنى منه فحصٌ
**يُثبَت بالدليل** أنه لا يقيس التغيير ولا يمكن إصلاحه برمجياً — ويُكتب
الاستثناءُ ومُبرِّرُه، فلا يصير سابقةً صامتة.
