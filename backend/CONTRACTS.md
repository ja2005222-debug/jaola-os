...
النقطتان ٢ (Tool Runtime) و٣ب (تنفيذُ TaskGraph فعليّاً بالتوازي) تبقيان كما
قِيستا في الإدخالات أعلاه: الثانية سقطت بالقياس (لا PR)، والثالثةُ بيانات
`dependsOn` فقط بلا تنفيذٍ متوازٍ فعليّ (سطرٌ منفصل).
