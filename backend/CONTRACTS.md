...
- **`ensureEditIntegrity` لا يستعيد رابطَ التنسيق المحلّيّ على كلونٍ ملمَّع**: شرطُه «لا روابطَ ولا `<style>`» بينما باقةُ التلميع تحقن `<style data-jaola-polish>` وروابطَ خطوطٍ بعيدة، فيظنّ الصفحةَ منسَّقة. مقيسٌ ومثبَّت كما هو في الاختبار — إصلاحُه في `codeGuard` قرارٌ مستقلّ.
