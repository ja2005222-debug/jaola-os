...
### دَينٌ مكتوب — ليس صمتاً بل سوءَ توجيه

`classifyIntent` يُرسل الرسالةَ **كاملةً** (٢٦ ألف حرف) لتصنيفٍ جوابُه `max_tokens: 80`. فشلُه على الطويل هو الذي أسقط
المواصفةَ في فرع «تعديلٍ جراحيّ» أصلاً. الإصلاحُ المرشَّح: التصنيفُ على صدرٍ محدود. لم يُنفَّذ هنا لأنّ هذه الجولةَ
**للصمت** لا للتوجيه، والخلطُ بينهما يجعل مقياسَ النجاح غامضاً.
