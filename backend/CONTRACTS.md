...
الـPR **مسودّة** عن قصد. الأرقامُ التي تُثبت الدعوى (١٦ جولةً بتزاحم ٨ تعدّ
`Unable to deserialize` وحدها) كانت تعمل حين كُتب هذا. **لا يُدمج قبل أن
تُكتب نتيجتُها هنا** — سلبيّةً كانت أو موجبة.
