...
| ✅ `stages/understand.js` (جديد، JCR/5؛ PM/1 يبذر الفهمَ من المراجع؛ PM/22 يقول «فهمي لا يمسّ طلبَك» بدل ابتلاعه؛ PM/23 يطرحه ويبني على عناوين صاحب المشروع) | 113 | `understandGoal(goal, ctx, reporter)` — الفهم: ذاكرة/ملفّ ← مخطّط ← نموذج المجال؛ نقلٌ حرفيّ، المُبلِّغُ وسيط | ADDED | Mission | `jcr._understandGoal` مفوِّضٌ من سطر؛ ٧ استيراداتٍ رحلت معها |
