...
## C) `backend/agents/*` — 143 وحدة (منها 42 قالب كلون)
...
| `router.js` | 109 | الموجّه الموحّد للرسائل | MODIFY | Mission | مع `ceoBrain` |
