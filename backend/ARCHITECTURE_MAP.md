...
## C) `backend/agents/*` — 141 وحدة (منها 42 قالب كلون)
...
| `router.js` | 105 | الموجّه الموحّد للرسائل | MODIFY | Mission | مع `ceoBrain` |
