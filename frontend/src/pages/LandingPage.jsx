  ...
  return (
    <div className="min-h-screen bg-[#03050A] text-slate-100 font-sans overflow-x-hidden selection:bg-cyan-500/50 selection:text-white">
      ...
      <section className="relative z-10 pt-40 pb-24 md:pt-48 md:pb-32 max-w-7xl mx-auto px-6 text-center">
        <div className="inline-flex items-center gap-2 bg-cyan-500/10 border border-cyan-500/20 text-cyan-300 px-4 py-1.5 rounded-full text-xs font-semibold mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <span className="h-2 w-2 rounded-full bg-cyan-400 animate-ping" />
          الإصدار المعرفي JCOS v4.0 متاح الآن
        </div>
        
        <h1 className="text-5xl md:text-7xl xl:text-8xl font-black tracking-tight leading-[1.1] mb-8 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100">
          فريق من الوكلاء<br/>
        ...
        <p className="text-slate-400 text-base md:text-lg max-w-2xl mx-auto mb-10 leading-relaxed animate-in fade-in slide-in-from-bottom-6 duration-700 delay-200">
