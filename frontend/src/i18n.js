...
const STRINGS = {
  ...
  qtInventory: { en: 'Inventory', ar: 'مخزون وجرد' },
  ...
  qbInventory: { en: 'Build an internal inventory system with low-stock alerts and reports', ar: 'ابني نظام مخزون داخلي مع تنبيه نفاد وتقارير' },
