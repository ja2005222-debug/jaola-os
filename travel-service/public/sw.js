 ...
 */
const CACHE_NAME = 'jatrava-shell-v10';
...
const SHELL = ['/', '/en/', '/ur/', '/nl/', '/i18n.js', '/trips.js', '/fare.js', '/manifest.webmanifest',
    '/icon.svg', '/logo.svg', '/icon-192.png', '/icon-512.png', '/icon-maskable-192.png', '/icon-maskable-512.png'];
