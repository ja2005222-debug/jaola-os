 ...
 *
 * مُصدَّرة كي يستعملها `duffelProvider.js` في مسار احتياطي واحد لحساب
 * `durationMin` — نسخةٌ ثانية من هذا التثبيت في ملفٍّ آخر تتباعد بصمت
 * (نفس درس ICS والتوطين المتكرر في هذا المستودع).
 */
