 ...
 *      مؤكَّد حرفياً (بلا جسم)، لكن ⚠️ **رد النجاح لم يُشاهَد بعد** — لم
 *      يُجرَّب إلغاء حي حتى الآن، فاستخراج مبلغ الاسترداد أدناه يبقى
 *      تخميناً، وأي اختلاف يظهر كقيمة null لا كفشل صامت.
 */
