/**
 * 📧 mailer.js — نسخة ذاتية الاحتواء من backend/services/mailer.js
 *
 * صفر استيراد من backend/ (قاعدة الخدمة الثابتة) — لذا نسخة مطابقة لا
 * استيراد مباشر. نفس المفتاح بالضبط RESEND_API_KEY يعمل إن كان مضبوطاً
 * أصلاً على المنصة — اختياري تماماً، غير مُفعّل → ردّ صريح notConfigured.
 */
