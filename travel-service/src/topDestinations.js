/**
 * 🗺️ topDestinations.js — وجهاتٌ **مقترحة** بصور Wikimedia + أرخص سعر حقيقي
 *
 * ⚠️ **مقترحة لا رائجة، والفرق ليس لفظياً**: القائمة أدناه منسَّقة يدوياً
 * ولا تعرف ما يبحث عنه الناس ولا ما يُحجز فعلاً. كانت الواجهة تسمّيها
 * «وجهات رائجة» — ادّعاءُ شعبيةٍ لا يسنده رقم، وهو من صنف «الخصم
 * المختلَق» الذي يحرّمه عرف المستودع. الاسم الآن يقول ما هي بالضبط.
 * ومتى تراكمت حجوزات حقيقية في travel_bookings صحّ اشتقاقُ الترتيب
 * منها — وعندها وحدها تُسمّى رائجة بحق.
 *
 ...
 *
 * ✅ **تأكّدت حيّة** (بلاغ المالك من jatrava.com: «الصور تظهر جيداً») —
 * كانت الصيغة من التوثيق العام غير مجرَّبة ضد شبكةٍ حية (نفس حجب النطاقات الجديدة الذي يطال
